...
<svelte:head>
	<title>Doctor of Physical Therapy | WSSU</title>
	<meta
		name = "description"
		content = "Explore the Doctor of Physical Therapy program at Winston-Salem State University."
	/>
</svelte:head>

<main>
	<h1>Doctor of Physical Therapy placeholder</h1>
</main>
