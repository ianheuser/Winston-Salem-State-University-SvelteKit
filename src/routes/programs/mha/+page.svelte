...
<svelte:head>
	<title>Master of Healthcare Administration | WSSU</title>
	<meta
		name = "description"
		content = "Explore the Master of Healthcare Administration program at Winston-Salem State University."
	/>
</svelte:head>

<main>
	<h1>Master of Healthcare Administration placeholder</h1>
</main>
