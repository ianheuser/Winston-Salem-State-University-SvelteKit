...
<svelte:head>
	<title>Master of Science in Rehabilitation Counseling | WSSU</title>
	<meta
		name = "description"
		content = "Explore the Master of Science in Rehabilitation Counseling program at Winston-Salem State University."
	/>
</svelte:head>

<main>
	<h1>Master of Science in Rehabilitation Counseling placeholder</h1>
</main>
