...
<svelte:head>
	<title>Master of Science in Occupational Therapy | WSSU</title>
	<meta
		name = "description"
		content = "Explore the Master of Science in Occupational Therapy program at Winston-Salem State University."
	/>
</svelte:head>

<main>
	<h1>Master of Science in Occupational Therapy placeholder</h1>
</main>
