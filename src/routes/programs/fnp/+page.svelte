...
<svelte:head>
	<title>Master of Science in Nursing - Family Practioning | WSSU</title>
	<meta
		name = "description"
		content = "Explore the Master of Science in Nursing - Family Practioning program at Winston-Salem State University."
	/>
</svelte:head>

<main>
	<h1>Master of Science in Nursing - Family Practioning placeholder</h1>
</main>
