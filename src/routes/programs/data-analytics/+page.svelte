...
<svelte:head>
	<title>Certificate in Data Analytics | WSSU</title>
	<meta
		name = "description"
		content = "Explore the Certificate in Data Analytics program at Winston-Salem State University."
	/>
</svelte:head>

<main>
	<h1>Certificate in Data Analytics placeholder</h1>
</main>
