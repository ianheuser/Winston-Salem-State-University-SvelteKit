...
<svelte:head>
	<title>Master of Business Administration | WSSU</title>
	<meta
		name = "description"
		content = "Explore the Master of Business Administration program at Winston-Salem State University."
	/>
</svelte:head>

<main>
	<h1>Master of Business Administration placeholder</h1>
</main>
